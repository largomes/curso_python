...
class Quarto(ABC):
    ...
    # confirmar os dados do cliente e gerar recibo na consola
    
        if not self.nome_cliente or not self.contato_cliente:
            print("Confirmação de dados do cliente!")
            print("_"*40)
            self.nome_cliente = input("Por favor, confirme o nome do cliente: ")
            self.contato_cliente = input("Por favor, confirme o contato do cliente: ")
            print("_"*40)
    ...
    # Apos gerar o recibo na consola perguntar se deseja salvar o recibo em arquivo
    
            salvar = input("Deseja imprimir o recibo ? (S/N): ").strip().upper()
            if salvar == 'S':
...
# função para efetuar a reserva do quarto
...
# função para libertar o quarto reservado
    ...
    def libertar(self):
        ...
        if not self.nif_cliente:
            self.nif_cliente = input("Por favor, insira o NIF do cliente para recibo: ")  # Solicitar o NIF do cliente
...
#calculo do valor a pagar pela reserva do quarto
...
# função para adicionar os quartos
    def adicionar_quarto(self, quarto: Quarto):
        ...
        print("_" * 100)
        # Exibe a tabela com os quartos após adicionar
        self.exibir_tabela_quartos()  
...
#função para a opção 4-reserva de quarto(s)
    ...
    def libertar_quarto(self, numero_quarto):
        ...
        if quarto:
            if quarto.reservado:  # Verifica se o quarto está reservado
                ...
                quarto.nif_cliente = input("Por favor, confirme o NIF do cliente: ")  # Solicita o NIF
...
# função para alterar a reserva
    ...
    def alterar_reserva(self, numero_quarto):
        ...
        if quarto and quarto.reservado:
            ...
            self.registrar_movimento("Reserva alterada", quarto.numero)
            ...
            try:
                ...
                if opcao == '1':
                    while True:
                        ...
                        # se o nº quarto existe logo após o número ser inserido
